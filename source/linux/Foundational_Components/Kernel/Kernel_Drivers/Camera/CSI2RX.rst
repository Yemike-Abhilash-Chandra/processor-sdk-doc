...
.. ifconfig:: CONFIG_part_variant in ('J721E')
   ...
   .. code-block:: text
      ...
      # For single IMX219 connected to RX port 0 on DS90UB954-Q1 EVM on J721E EVM:
      => setenv name_overlays ti/k3-j721e-evm-ub954.dtbo ti/k3-v3link-imx219-0-0.dtbo
      => boot
   ...
   The following combinations of sensors are tested in the latest sdk.
       ...
       +--------------+---------------------------------------+-----------------------------------+
       | J721E EVM    | DS90UB954-Q1 EVM, IMX219              | SRGGB8_1X8/1920x1080 at 30 fps    |
       +--------------+---------------------------------------+-----------------------------------+
...
.. ifconfig:: CONFIG_part_variant in ('J721S2')
   ...
   .. code-block:: text
      ...
      # For single IMX219 connected to RX port 0 on DS90UB954-Q1 EVM on J721S2 EVM:
      => setenv name_overlays ti/k3-j721s2-evm-ub954.dtbo ti/k3-v3link-imx219-0-0.dtbo
      => boot
   ...
   The following combinations of sensors are tested on J721S2 in the latest sdk.
      ...
      +--------------+---------------------------------------+-----------------------------------+
      | J721S2       | DS90UB954-Q1 EVM, IMX219              | SRGGB8_1X8/1920x1080 at 30 fps    |
      +--------------+---------------------------------------+-----------------------------------+
...
.. ifconfig:: CONFIG_part_variant in ('J784S4','J742S2')
   ...
   .. code-block:: text
      ...
      # For single IMX219 connected to RX port 0 on DS90UB954-Q1 EVM on J784S4/J742S2 EVM:
      => setenv name_overlays ti/k3-j721s2-evm-ub954.dtbo ti/k3-v3link-imx219-0-0.dtbo
      => boot
   ...
   The following combinations of sensors are tested in the latest sdk.
      ...
      +--------------+---------------------------------------+-----------------------------------+
      | J784S4       | DS90UB954-Q1 EVM, IMX219              | SRGGB8_1X8/1920x1080 at 30 fps    |
      +--------------+---------------------------------------+-----------------------------------+
